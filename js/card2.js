document.getElementById('donate-btn-2')
    .addEventListener('click', function (event) {
        ...
        const inputAmount = getInputValueById('input-amount-2');
        ...
        const cardBalance = getFieldValueById('card-balance-2');
        const newBalance = inputAmount + cardBalance;
            alert(`added some money ${inputAmount}`);

        document.getElementById('card-balance-2').innerText = newBalance;
