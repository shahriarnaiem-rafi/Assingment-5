document.getElementById('donate-btn-3')
    .addEventListener('click', function (event) {
        ...
        const inputAmount = getInputValueById('input-amount-3');
        ...
        const cardBalance = getFieldValueById('card-balance-3');
        const newBalance = inputAmount + cardBalance;
            alert(`added some money ${inputAmount}`);

        document.getElementById('card-balance-3').innerText = newBalance;
